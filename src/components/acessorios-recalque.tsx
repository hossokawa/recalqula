...
export const AcessoriosRecalque = ({
  formAcessorioControl,
  handleAcessorioRecalqueSubmit,
  camposAcessoriosRecalque,
  updateRecalque,
  removeRecalque,
  modalAcessoriosRecalqueAberto,
  setModalAcessoriosRecalqueAberto
}) => {
  return (
    <div className="p-4 bg-gray-100 rounded-md space-y-3 mt-6">
      ...
      <Dialog open={modalAcessoriosRecalqueAberto} onOpenChange={setModalAcessoriosRecalqueAberto}>
        ...
        <DialogContent className="sm:max-w-[425px]">
          ...
          />
          <DialogFooter>
            <Button type="button" onClick={handleAcessorioRecalqueSubmit}>Adicionar</Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
